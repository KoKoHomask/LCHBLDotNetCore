...
namespace LCHBLDotNetCore.Other
{
    public class 杂七杂八的方法
    {
        ...
        class GetHttpID
        {
            public static DotNet4.Utilities.HttpResult GETResult(string URL)
            {
                DotNet4.Utilities.HttpItem item = new DotNet4.Utilities.HttpItem();
                DotNet4.Utilities.HttpHelper helper = new DotNet4.Utilities.HttpHelper();
                item.URL = URL;
                DotNet4.Utilities.HttpResult result = helper.GetHtml(item);
                return result;
            }

            public static string GETSTR(DotNet4.Utilities.HttpResult result, string message)
            {
                string str = null;
            ...
            public static int GETINT(DotNet4.Utilities.HttpResult result, string message)
            {
                int num = 0;
                HtmlAgilityPack.HtmlDocument doc = new HtmlAgilityPack.HtmlDocument();
                doc.LoadHtml(result.Html);
